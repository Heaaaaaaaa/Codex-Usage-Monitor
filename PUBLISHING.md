...
CodexUsageMonitor-0.4.2.zip
CodexUsageMonitor-0.4.2.zip.sha256
CodexUsageMonitor-0.4.2.dmg
CodexUsageMonitor-0.4.2.dmg.sha256
CodexUsageMonitor-0.4.2.manifest.json
```
...
git tag -a v0.4.2 -m "Codex Usage Monitor 0.4.2"
